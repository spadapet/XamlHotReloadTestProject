...
namespace WinUWP
{
    ...
    public class ObservableCollection<T> : Collection<T>, Microsoft.UI.Xaml.Interop.INotifyCollectionChanged, INotifyPropertyChanged
    {
        ...
        protected override void ClearItems()
        {
            ...
            base.ClearItems();
            OnCollectionChanged(
                Microsoft.UI.Xaml.Interop.NotifyCollectionChangedAction.Reset,
                null, oldItems, 0, 0);
        }
        ...
        protected override void InsertItem(int index, T item)
        {
            ...
            OnCollectionChanged(
                Microsoft.UI.Xaml.Interop.NotifyCollectionChangedAction.Add,
        ...
        protected virtual void MoveItem(int oldIndex, int newIndex)
        {
            ...
            OnCollectionChanged(
                Microsoft.UI.Xaml.Interop.NotifyCollectionChangedAction.Move,
        ...
        protected override void RemoveItem(int index)
        {
            ...
            OnCollectionChanged(
                Microsoft.UI.Xaml.Interop.NotifyCollectionChangedAction.Remove,
        ...
        protected override void SetItem(int index, T item)
        {
            ...
            OnCollectionChanged(
                Microsoft.UI.Xaml.Interop.NotifyCollectionChangedAction.Replace,
                newItem, oldItem, index, index);
        }

        protected virtual void OnCollectionChanged(
            Microsoft.UI.Xaml.Interop.NotifyCollectionChangedAction action,
